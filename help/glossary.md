...
**Addax**: A decentralized leveraged trading platform on LitVM, built on the gTrade / Gains Network architecture.
...
**Leverage**: Multiplier applied to your collateral to size a position (1x–100x). Position size = collateral x leverage.

**Position size / Notional**: The USD-denominated exposure of a trade (collateral x leverage). Fees are charged on notional.
...
**zkLTC / WzkLTC**: The native LitVM gas token and its wrapped ERC-20 form (used as margin).

**LitVM**: The testnet chain (ID 4441) Addax is deployed on.
