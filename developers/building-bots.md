...
## Start here: [addax-protocol/bots](https://github.com/addax-protocol/bots)

Reference keeper bots live in the **[addax-protocol/bots](https://github.com/addax-protocol/bots)** GitHub repository. Clone that repo, follow its README, and configure the required environment variables there. Keep keys and operator secrets out of public channels.
...
Exact variable names, ABIs, and helper modules are documented in [addax-protocol/bots](https://github.com/addax-protocol/bots). Treat that repo as the source of truth.
