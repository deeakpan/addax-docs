...
Addax is a leveraged trading protocol built on the gTrade / Gains Network contract architecture, deployed on LitVM LiteForge. This page describes the on-chain components, how they interact, and the external infrastructure Addax leans on.
