...
Reference implementations and setup live in **[addax-protocol/bots](https://github.com/addax-protocol/bots)** on GitHub. Start from that repository: configure RPC access, a gas-funded signing wallet, keeper authorization (NFT), and any indexing/state settings the bots expect.
