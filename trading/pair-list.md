...
All markets currently available on Addax. Each pair has a `pairIndex` used on-chain and in the contracts, an asset class, and an oracle key used by the price feed.
...
| TSLA | Tesla | Equity | 4 | `TSLA/USD` |
| SPCX | SpaceX | Equity | 5 | `SPCX/USD` |
| SOL | Solana | Crypto | 6 | `SOL/USD` |
| HYPE | Hyperliquid | Crypto | 7 | `HYPE/USD` |
...
- **Oracle key** is the feed identifier resolved by the Addax/DIA price aggregator (see [Price Oracle](../protocol/price-oracle.md)).
